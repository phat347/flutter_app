...
class LoadMoreCustom extends StatefulWidget {
  ...
  static DelegateBuilder<LoadMoreTextBuilder> buildTextBuilder =
      () => DefaultLoadMoreTextBuilder.vietnam;
  ...
  @override
  _LoadMoreCustomState createState() => _LoadMoreCustomState();
}

class _LoadMoreCustomState extends State<LoadMoreCustom> {
  Widget get child => widget.child;

  LoadMoreDelegate get loadMoreDelegate =>
      widget.delegate ?? LoadMoreCustom.buildDelegate();
    ...
    return NotificationListener<_RetryNotify>(
      child: NotificationListener<_BuildNotify>(
        child: DefaultLoadMoreView(
          ...
          textBuilder: widget.textBuilder ?? LoadMoreCustom.buildTextBuilder(),
        ),
...
abstract class LoadMoreDelegate {
  ...
  Widget buildChild(LoadMoreStatus status,
      {LoadMoreTextBuilder builder = DefaultLoadMoreTextBuilder.vietnam});
}
          ...
          children: <Widget>[
            SizedBox(
              ...
              child: CircularProgressIndicator(
                ...
                valueColor: new AlwaysStoppedAnimation<Color>(HattoColors.colorPrimary),
              ),
            ),
            Padding(
...
String _buildVietNamText(LoadMoreStatus status) {
  String text;
  switch (status) {
    case LoadMoreStatus.fail:
      text = "Tải thất bại, bấm để thử lại";
      break;
    case LoadMoreStatus.idle:
      text = "Đang tải...";
      break;
    case LoadMoreStatus.loading:
      ...
      break;
    case LoadMoreStatus.nomore:
      text = "Không còn dữ liệu để tải thêm";
      break;
    default:
      text = "";
  }
...
class DefaultLoadMoreTextBuilder {
  ...
  static const LoadMoreTextBuilder vietnam = _buildVietNamText;
